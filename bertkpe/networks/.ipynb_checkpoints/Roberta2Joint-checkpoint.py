...
# -------------------------------------------------------------------------------------------
class RobertaForCnnGramKernelRanking(BertPreTrainedModel):
    def __init__(self, config):
        super(RobertaForCnnGramKernelRanking, self).__init__(config)
...
class RobertaForChunkTFRanking(RobertaForCnnGramKernelRanking):
    def forward(
        self,
        input_ids,
        attention_mask,
