...
# -------------------------------------------------------------------------------------------
class BertForAttSpanClassification(BertPreTrainedModel):
    def __init__(self, config):
        super(BertForAttSpanClassification, self).__init__(config)
...
# -------------------------------------------------------------------------------------------
# Bert2AttSpanExtractor
# -------------------------------------------------------------------------------------------
class BertForAttSpanExtractor(BertForAttSpanClassification):
    def forward(
        self,
        input_ids,
        attention_mask,
