...
from transformers import DistilBertPreTrainedModel, DistilBertModel, AutoModel, DistilBertForMaskedLM
...
# -------------------------------------------------------------------------------------------
class DistilBertForCnnGramKernelRanking(DistilBertForMaskedLM):
    
    def __init__(self, config):
        super(DistilBertForCnnGramKernelRanking, self).__init__(config)
        
        max_gram = 5
        cnn_output_size = 512
        cnn_dropout_rate = config.dropout
        
        self.num_labels = config.num_labels
        
        self.distilbert = DistilBertModel.from_pretrained("distilbert-base-multilingual-cased")

        # Freezing the parametes of the bert model
...
# ------------------------------------------------------------------------------------------- 
class DistilBertForChunkTFRanking(DistilBertForCnnGramKernelRanking):
