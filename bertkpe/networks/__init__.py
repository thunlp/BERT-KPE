def get_class(args):
    ...
    # Bert2Span
    if args.model_class == "bert2span" and args.pretrain_model_type in [
        "bert-base-cased",
        "spanbert-base-cased",
    ]:
    ...
    # Bert2Tag
    elif args.model_class == "bert2tag" and args.pretrain_model_type in [
        "bert-base-cased",
        "spanbert-base-cased",
    ]:
    ...
    # Bert2Chunk
    elif args.model_class == "bert2chunk" and args.pretrain_model_type in [
        "bert-base-cased",
        "spanbert-base-cased",
    ]:
        return BertForCnnGramExtractor
    elif (
        args.model_class == "bert2chunk" and args.pretrain_model_type == "roberta-base"
    ):
        return RobertaForCnnGramExtractor

    # Bert2Rank
    elif args.model_class == "bert2rank" and args.pretrain_model_type in [
        "bert-base-cased",
        "spanbert-base-cased",
    ]:
    ...
    # Bert2Joint
    elif args.model_class == "bert2joint" and args.pretrain_model_type in [
        "bert-base-cased",
        "spanbert-base-cased",
    ]:
        ...
        args.model_class == "bert2joint" and args.pretrain_model_type == "roberta-base"
    ):
