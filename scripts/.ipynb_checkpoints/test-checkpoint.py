...
if __name__ == "__main__":
    ...
    dev_stats = evaluate_script(
        args, dev_candidate, dev_stats, mode="dev", metric_name=main_metric_name
    )
    ...
    if args.dataset_class == "kp20k":
        ...
        eval_stats = evaluate_script(
            args, eval_candidate, eval_stats, mode="eval", metric_name=main_metric_name
        )
